/*
  ...
  - You are about to drop the column `uuid` on the `Credit` table. All the data in the column will be lost.

*/
-- DropIndex
DROP INDEX "Credit.uuid_unique";
...
CREATE UNIQUE INDEX "unique_credit_id" ON "Credit"("tmdb_id", "show_id", "known_for_department");
