...
const SearchResultsSelectedItem = ({
  currentSlide,
  additionalMovieInfo,
  ...
  const preCloseInformationWindow = () => {
    let searchResultDetail = document.getElementById(
          ...
          <React.Fragment>
            <div className="ai-content-area">
                  ...
                  <div className="jaw-bone-common">
                    ...
                    <div className="meta-lists">
                      <p className="inline-list">
                        <span>Featuring:</span>
                        {additionalMovieInfo.credits.cast.map(
                          (person, index) => {
              ...
              <button
                ...
                onClick={() => preCloseInformationWindow()}
              >
                <span>
