...
const FormThree = () => {
    ...
    return (
        <div className="container">
            <p>Find the {updateContext.selectedFile.type}<b>{updateContext.selectedFile.fs_path}</b></p>
            <div className="formContain">
            <form className="form">
                {updateContext.selectedFile && <div className="tabcontent">
                ...
                {updateContext.selectedFile.type == "Movie" && searchResults && searchResults.results.map(item => (
                <div className="search-result-item">
                ...
                {updateContext.selectedFile.type == "Song" && searchResults && searchResults.tracks.items.map(item => (
                    <div className="search-result-item">
